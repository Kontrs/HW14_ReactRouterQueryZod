  ...
  return (
    <>
      ...
      <div className={styles.imageWrapper}>
        <img className={styles.image1} src="public/gaming.jpg" alt="gaming" />
        <img className={styles.image2} src="public/bmxsupercross.jpg" alt="bmxsupercross" />
        <img className={styles.image3} src="public/climbing.jpg" alt="climbing" />
      </div>
    </>
  )
}